...
const CATEGORIES_GUIDE: CategoryGuide[] = [
  { num: '01', name: 'Dashboard', icon: BarChart3, desc: 'Real-time performance metrics, account health, equity curve, quick HUD.', color: 'text-amber-400' },
  ...
  { num: '08', name: 'Premium Signals', icon: Zap, desc: 'Institutional trade setups, technical bias, invalidation levels, targets.', color: 'text-amber-400' },
  ...
  { num: '15', name: 'Freehand Canvas', icon: Palette, desc: 'Fullscreen multi-tool chart sketching, markup, annotations, and export.', color: 'text-amber-400' },
...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl max-h-[92vh] bg-[#0B0F19] border border-amber-500/30 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Animated Top Accent Shimmer */}
        <div className="h-1 bg-gradient-to-r from-amber-500 via-teal-400 to-indigo-500 animate-pulse" />
        ...
        <div className="px-6 py-5 border-b border-slate-800/80 bg-slate-950/60 flex items-start justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs font-mono-code text-amber-400/90 font-semibold">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-slate-900 text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition cursor-pointer border border-slate-800"
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-slate-300 text-xs sm:text-sm">
          {/* Mission & Purpose */}
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 sm:p-5 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="bg-[#070B14] border border-slate-800/80 rounded-xl p-3.5 space-y-1.5">
              <div className="flex items-center gap-2 text-amber-400 font-military text-xs font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {CATEGORIES_GUIDE.map((cat) => {
                ...
                return (
                  ...
                  >
                    <div className={`p-2 rounded-lg bg-slate-900 border border-slate-800 ${cat.color} shrink-0 mt-0.5`}>
        ...
        <div className="px-6 py-4 border-t border-slate-800 bg-slate-950/80 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              type="button"
              onClick={handleFinish}
              className="flex items-center gap-2 px-5 py-2 rounded-xl text-xs font-military font-bold bg-amber-500 hover:bg-amber-400 text-slate-950 transition cursor-pointer shadow-lg shadow-amber-500/20"
            >
