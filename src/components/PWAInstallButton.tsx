    ...
    return (
      <div className="relative">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 border border-amber-500/30 text-xs font-military font-bold tracking-wider transition"
        ...
        {showIOSPrompt && (
          <div className="absolute right-0 mt-2 w-64 p-3 rounded-xl bg-slate-900 border border-amber-500/40 shadow-2xl z-50 text-xs font-mono-code text-slate-300">
            <p className="font-bold text-amber-400 mb-1">Install on iOS:</p>
