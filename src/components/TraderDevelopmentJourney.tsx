    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-5 shadow-xl flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="text-right font-mono-code text-xs">
          ...
          <div className="text-amber-400 font-bold font-military text-sm mt-0.5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        ...
        <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-4 space-y-1">
          ...
          <div className="text-2xl font-bold font-military text-amber-400">{riskScore}%</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {phase.isCurrent && (
                        <span className="text-[10px] font-mono-code font-bold px-2 py-0.5 rounded bg-amber-500 text-slate-950 animate-pulse">
                          ACTIVE FOCUS
                        </span>
                      )}
