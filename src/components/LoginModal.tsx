  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-md prime-gradient-box p-6 sm:p-8 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-slate-400 hover:text-slate-100 transition rounded-xl bg-slate-900/60 hover:bg-slate-800 border border-slate-700/60 cursor-pointer"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        {step === 'CHANGE_PASSWORD' ? (
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-950 border border-slate-700 rounded-xl font-mono-code text-sm text-slate-100 focus:outline-none focus:border-amber-400"
                />
            ...
            <button
              ...
              className="w-full mt-2 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-military font-bold text-xs tracking-wider uppercase rounded-xl transition-all shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-700 rounded-xl font-mono-code text-sm text-slate-100 focus:outline-none focus:border-amber-400"
                />
