...
const DEFAULT_SENTIMENT_DATA: PairSentimentRecord[] = [
  {
    id: 'sent_eurusd',
    pair: 'EURUSD',
    longPercent: 42.0,
    ...
    shortVolume: 58000,
    longPositions: 14200,
    shortPositions: 19600,
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/EURUSD',
    longShortRatio: 0.72,
    netSentiment: -16.0,
    sentimentScore: 20,
  ...
  },
  {
    ...
    shortVolume: 59000,
    longPositions: 11000,
    shortPositions: 20900,
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/GBPUSD',
    longShortRatio: 0.53,
    netSentiment: -31.0,
    sentimentScore: 39,
    sentimentRegime: 'CROWD_SHORT_BULLISH_EDGE',
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'sent_usdjpy',
    ...
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/USDJPY',
    longShortRatio: 2.88,
    netSentiment: 48.4,
    sentimentScore: -61,
    sentimentRegime: 'CROWD_LONG_BEARISH_EDGE',
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'sent_audusd',
    ...
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/AUDUSD',
    longShortRatio: 1.56,
    netSentiment: 22.0,
    sentimentScore: -28,
    sentimentRegime: 'NEUTRAL',
  ...
  },
  {
    ...
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/USDCAD',
    longShortRatio: 1.06,
    netSentiment: 3.0,
    sentimentScore: -4,
    sentimentRegime: 'NEUTRAL',
  ...
  },
  {
    ...
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/USDCHF',
    longShortRatio: 3.55,
    netSentiment: 56.0,
    sentimentScore: -70,
    sentimentRegime: 'CROWD_LONG_BEARISH_EDGE',
  ...
  },
  {
    ...
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/NZDUSD',
    longShortRatio: 0.89,
    netSentiment: -6.0,
    sentimentScore: 8,
    sentimentRegime: 'NEUTRAL',
  ...
  },
  {
    ...
    shortVolume: 42000,
    longPositions: 38000,
    shortPositions: 17500,
    reportTimestamp: '2026-09-21 14:00 UTC',
    source: 'Myfxbook Community Outlook',
    sourceUrl: 'https://www.myfxbook.com/community/outlook/XAUUSD',
    longShortRatio: 2.17,
    netSentiment: 37.0,
    sentimentScore: -46,
    sentimentRegime: 'CROWD_LONG_BEARISH_EDGE',
...
export const MarketSentimentView: React.FC<MarketSentimentViewProps> = ({
  sentimentRecords = DEFAULT_SENTIMENT_DATA,
