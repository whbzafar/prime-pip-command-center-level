...
export const AmbientMixer: React.FC<AmbientMixerProps> = ({ userId = 'default', onSaveCustomMix }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950/70 to-slate-900 border border-white/[0.08] shadow-xl flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono-code px-1.5 py-0.5 rounded bg-amber-500/15 text-amber-400 border border-amber-500/30">
              15 CHANNELS
            </span>
          </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-xs font-military font-bold text-rose-300 hover:bg-rose-500/10 hover:border-rose-500/40 transition disabled:opacity-40 flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl border text-xs font-military font-bold transition flex items-center gap-1.5 cursor-pointer ${
              isMuted
                ...
                : 'bg-slate-900 border-slate-800 text-slate-300 hover:text-teal-300'
            }`}
          >
      ...
      {isSaving && (
        <div className="p-4 rounded-xl bg-slate-900/95 border border-teal-500/40 space-y-3 animate-in fade-in">
      ...
      <div className="p-3.5 rounded-xl bg-slate-950/60 border border-white/[0.08] flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2 text-xs font-military text-slate-300">
          ...
          {timerSecondsRemaining !== null && (
            <span className="font-mono-code text-amber-400 font-bold px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20">
